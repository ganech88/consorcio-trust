...
export default function LoginPage({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex items-center justify-center p-4 font-sans">
      ...
      <div className="relative bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-md animate-fade-in-up border border-white/20 dark:border-slate-700/50">
        {/* Logo */}
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 tracking-tight">ConsorcioTrust</h1>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 border border-slate-200 dark:border-slate-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all bg-slate-50/50 dark:bg-slate-700 dark:text-slate-100 hover:bg-white dark:hover:bg-slate-700"
